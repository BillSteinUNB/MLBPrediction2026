...
- Control lane remains intact.
- Stage 3 distribution lane is the promoted second-opinion lane.
- Stage 4 MCMC lane remains exploratory.

Archived non-MLB material:
